...
var HistoryTable = (function () {
    ...
    HistoryTable.prototype.addEntry = function (index, nextPCTaken, nextPCNoTaken, tag, isTaken) {
        var _this = this;
        var entry = new history_table_entry_1.HistoryTableEntry(null, index, null, nextPCNoTaken, nextPCTaken, tag);
