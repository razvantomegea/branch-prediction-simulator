...
var HistoryRegister = (function () {
    ...
    HistoryRegister.prototype.addEntry = function (history, pcPath, pcLow, taken) {
        var HRentry = new history_register_entry_1.HistoryRegisterEntry(pcLow, history, pcPath, taken ? 1 : 0, !taken ? 1 : 0);
